...
const staticPages: { path: string; changeFrequency: "weekly" | "monthly"; priority: number }[] = [
  ...
  { path: "/services/platform-migration/woocommerce-migration", changeFrequency: "monthly", priority: 0.85 },
  { path: "/services/platform-migration/shopify-migration", changeFrequency: "monthly", priority: 0.85 },
  { path: "/services/platform-migration/b2b-platform-migration", changeFrequency: "monthly", priority: 0.85 },
