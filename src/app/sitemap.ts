...
const staticPages: { path: string; changeFrequency: "weekly" | "monthly"; priority: number }[] = [
  ...
  { path: "/services/platform-migration", changeFrequency: "weekly", priority: 1.0 },
  { path: "/services/platform-migration/woocommerce-migration", changeFrequency: "weekly", priority: 1.0 },
  { path: "/services/platform-migration/shopify-migration", changeFrequency: "weekly", priority: 1.0 },
  { path: "/services/platform-migration/b2b-platform-migration", changeFrequency: "weekly", priority: 1.0 },
